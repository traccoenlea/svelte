...
<div class="fond">
    ...
    <div id="sideForm" class="sideForm">
        ...
        <div id="form">
            <!--<label class="what" for="changeFormation">Nom de la formation : </label> -->
            <input class="nom" type="text" id="changeFormation" bind:value={nomFormation}/>

            <div class="langue">
                <label for="changeLieu">
                    <!--<img src={location} alt="icone de lieu de formation">-->
                </label>
            ...
            <div class="heures">
               <!-- <label class="what" for="changeHeures">Nombre d'heures d'enseignements : </label> -->
        ...
        <div class="si">
            ...
            <div class="lolo">
             ...
             <div class="lulu">
                <!--<label class="what" for="fontChange">Fond :</label>-->
