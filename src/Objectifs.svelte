...
<div class="fond">
    <div class="groupe">
        <div class="groupe1">
            ...
            <h1 class="orange"> DE LA FORMATION</h1>
            ...
            <p class="inter"> • De concevoir et de créer des contenus appropriés à chaque site et répondant à des
                besoins spécifiques (écrits, visuels, infographiques). </p>
        </div>
