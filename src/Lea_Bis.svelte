...
<div id="both">
    <div id="left">
        <h1 id="nomFormation">{nomFormation}</h1>
        <h1 id="lieuFormation">{lieuFormation}</h1>
        <h1 id="bacDebut">{bacDebut}</h1>
        <h1 id="bacSortie">{bacSortie}</h1>
        <h1 id="modalites">{modalites}</h1>
    </div>
